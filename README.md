...
| Part 2 | Stop Putting Everything in One Terraform State: Use Terragrunt Dependency Blocks | [Read on Dev.to](https://dev.to/jeancy/stop-putting-everything-in-one-terraform-state-use-terragrunt-dependency-blocks-1lhl) |
